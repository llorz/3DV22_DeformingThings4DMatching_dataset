...
lmk1_2 = dlmread([base_dir, 'cross_category_corres/', s1_cate_name, '_', s2_cate_name, '.vts']);
lmk2_1 = dlmread([base_dir, 'cross_category_corres/', s2_cate_name, '_', s1_cate_name, '.vts']);
%% construct the map
T12 = nan(S1.nv, 1);
T12(lmk1) = lmk2(lmk1_2);
